# module that does inference, based on the notebook, organized for such
...
def inference(text, ref_s, alpha = 0.3, beta = 0.7, diffusion_steps=5, embedding_scale=1):
    text = text.strip()
    ps = phonemizer_wrapper.phonemize([text])
...
def main():
    ...
    for k, path in reference_dicts.items():
        ...
        sf.write(f"Demo/reference_audio/synth/{k}.wav", wav, 24000)
